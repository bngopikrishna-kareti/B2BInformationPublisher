...
<div class="btn-group">
    <a href="show.php"><button type="button" class="btn btn-warning" id="liveToastBtn">Home</button></a></div>
   
  </div>
  <a href="/adminclient/index.php"><button type="button" class="btn btn-warning" id="liveToastBtn">Clients</button></a>
  
  <div class="btn-group">
    <a href="RM Page.php"><button type="button" class="btn btn-warning">RMs</button></a>
...
if ($_GET['submit'])
{
	...
	$address = $_GET['address'];
 	$sql="UPDATE adprofile SET firstname='$firstname' , lastname='$lastname', gmail='$gmail' , number='$number', address='$address'   WHERE id='$id'";
