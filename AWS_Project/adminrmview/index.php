...
if (isset($_POST['submit'])) {
	...
	$sql = "INSERT INTO `rm` VALUES ('$id','$firstname','$lastname','$gmail','$number','$address')";
	$data=mysqli_query($con,$sql);
	if ($data) {
		echo "Added Relational Manager Succesfully";
	}else
	{
		echo "sorry";
	}
...
<div class="btn-group">
  ...
  <div class="row text-center">
	...
	<input type="text" name="firstname" placeholder="RM Name"><br><br>
	<input type="text" name="lastname" placeholder="Field Alloted"><br><br>
...
<button><a class="btn btn-danger" href="show.php">show RMs</a></button>
	</div>
</div>
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anonymous"></script>
</body>
